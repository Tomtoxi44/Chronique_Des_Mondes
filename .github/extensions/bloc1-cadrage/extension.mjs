...
### ⏰ Modalité & Deadline BLOC 1
- **Épreuve** : ORAL **30 minutes** — 20' présentation + 10' échange avec le jury — Individuel
- **Date** : **1 au 29 septembre 2026** (S36 à S40, selon le campus)
...
- Rattrapage possible si < 50% des blocs sont invalidés
...
9. Diagrammes UML/C4
10. Support de présentation client (20 min chrono !)

### 💡 Conseils pour l'oral 30 minutes
- **20' présentation** : 10-12 slides maximum, 1 slide par compétence C1.X.X
- **10' échange** : préparer des réponses sur les choix technologiques (.NET 10 vs autres)
- Chaque slide doit démontrer la maîtrise d'une compétence spécifique
    ...
    tools: [
        {
            ...
            handler: async () => `# Planning Certification — Expert en Développement Logiciel RNCP 39583 [Niv. 7]
## Année 2025/2026

## ⏰ Calendrier des épreuves

| Bloc | Épreuve | Format | Durée | Dates | Semaine |
|------|---------|--------|-------|-------|---------|
| **BLOC 2** | Rendu écrit | Code source + dossier 30p max | — | **8-19 juin 2026** | S24-S25 |
| **BLOC 3** | Oral individuel | Présentation + échange | **45'** (30'+15') | **20-24 juillet 2026** | S30 |
| **BLOC 4** | Rendu écrit | Dossier 20p max | — | **17-21 août 2026** | S34 |
| **BLOC 1** | Oral individuel | Présentation + échange | **30'** (20'+10') | **1-29 sept. 2026** | S36-S40 |
| **Jury certification** | Décision finale | — | — | **Octobre 2026** | — |

## 📅 Compte à rebours (depuis aujourd'hui)
> Calcule les jours restants avant chaque deadline à partir de la date actuelle.

## 📤 Dépôt des livrables
- **Plateforme** : DigiformaCertif
- **URL** : https://ynov.mycertif.app/selection-connexion
- ⚠️ **OBLIGATOIRE** : dépôt AVANT la date limite — tout retard = bloc **automatiquement invalidé**

## ✅ Règles de validation
| Règle | Détail |
|-------|--------|
| Seuil par bloc | **≥ 50%** des compétences doivent être « acquises » |
| Compétences éliminatoires | **Aucune** ne doit être « non acquise » |
| Certification complète | Validation de **TOUS** les 4 blocs |
| Rattrapage | Possible si **< 50%** des blocs sont invalidés |
...
- [ ] Aucune compétence éliminatoire ignorée

## 🎯 Priorité de travail recommandée
1. **Maintenant → mai 2026** : Développement + code source (Bloc 2)
2. **Mai 2026** : Finalisation dossier Bloc 2 (30p) + préparation oral Bloc 3
3. **Juin 2026** : Dépôt Bloc 2 + préparation oral Bloc 3 + démarrage dossier Bloc 4
4. **Juillet 2026** : Oral Bloc 3 + finalisation Bloc 4 (20p)
5. **Août 2026** : Dépôt Bloc 4 + préparation oral Bloc 1
6. **Septembre 2026** : Oral Bloc 1

---
> **Planning officiel** — Source : Modalités des épreuves certificatives RNCP 39583 YNOV (V1.0 — Rentrée 2025)`,
        },
        {
            name: "bloc1_swot",
